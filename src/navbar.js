...
function NavigationBar() {
  return (
    <header className="navbar navbar-expand navbar-dark bg-dark flex-column flex-md-row" style={{position: 'sticky', top: 0, zIndex: 1071}}>
      <a className="navbar-brand" href="#">
        <img className="d-block" width="36" height="36" src="/logo.svg"/>
      </a>
